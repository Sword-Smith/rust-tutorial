...
pub fn test() {
    ...
    let kp_real = Polynomial::keygen(&pqr_real);
    let ct_real = Polynomial::encrypt(&kp_real.pk, pt_modulus_real, pt_real);
    let dec_real = Polynomial::decrypt(&kp_real.sk, pt_modulus_real, &ct_real);
    println!(
